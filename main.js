...
document.getElementById("add").onclick = function () {
    ...
    var cal_text = document.getElementById("cal").value;
    ...
    // Para cargar calificacion en td, primero crea un nodo td
    var td_cal_node = document.createElement("td");
    // El valor ingresado es texto, no un nodo. Si desea agregarlo a través de un nodo, debe convertirse en un nodo de texto
    var cal_text_node = document.createTextNode(cal_text);
    // Agregar nodo calificacion
    td_cal_node.appendChild(cal_text_node);
